...
class AddCareerView extends StatefulWidget {
  const AddCareerView({Key? key}) : super(key: key);

  @override
  State<AddCareerView> createState() => _AddCareerViewState();
}

class _AddCareerViewState extends State<AddCareerView> {
  @override
  Widget build(BuildContext context) {
    final formKey = GlobalKey<FormState>();

    final TextEditingController nameController = TextEditingController();
    CareersService careerService = CareersService();
                        ...
                        MaterialButton(
                          onPressed: () async {
                            if (formKey.currentState!.validate()) {
                              ...
                              await careerService.addCareer(name);

                              // Cerrar el modal después de guardar
                              Navigator.pushReplacementNamed(
                                  currentContext, Routes.career);
                            }
                          },
